...
// CODE HERE
const last = ([], cb) => cb(names[6])
//OR const last = (arr, cb) => cb(arr[arr.length - 1])
//const last = ([], cb) => cb(names[names.length - 1])
...
// CODE HERE 
const contains = ([], name, cb) => cb(bool)
